        ...
        <div  className="container m-8 grid gap-4 gap-x-3 md:grid-cols-2 lg:grid-cols-3">
            <div  className="card  w-80 bg-primary text-primary-content">
                <div  className="card-body">
                    <h2  className="card-title text-center text-accent">How will you improve the performance of react Application??</h2>
            ...
            <div  className="card ml-2 w-80 bg-primary text-primary-content">
                <div  className="card-body">
                    <h2  className="card-title text-center text-accent">What are the different ways to manage a state in a react application??</h2>
            ...
            <div  className="card w-80 bg-primary text-primary-content">
                <div  className="card-body">
                    <h2  className="card-title text-center text-accent">How does prototypical inheritance work?</h2>
            ...
            <div  className="card w-80 bg-primary text-primary-content">
                <div  className="card-body">
                    <h2  className="card-title text-center text-accent">Why do not set the state directly in react??</h2>
            ...
            <div  className="card w-80 bg-primary text-primary-content">
                <div  className="card-body">
                    <h2  className="card-title  text-center text-accent">How will you implement a search to find products by name??</h2>
                    <p>Searching allows customers to find certain products that satisfy a set of criteria.What we can do instead is to give the React Components we're interested in finding, a certain css  className name, which  then we can find in the DOM. we can of course also use id and use document. getElementById() (if the id is unique) or name and use document. getElementsByName() , and other methods.</p>
                </div>
            </div>

            <div  className="card w-80 bg-primary text-primary-content">
                <div  className="card-body  ">
                    <h2  className="card-title text-center text-accent">What is a unit test? Why should write unit test??</h2>
